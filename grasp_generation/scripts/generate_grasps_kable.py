...
from utils.initializations_kable import initialize_convex_hull
...
if __name__ == '__main__':
    ...
    # experiment settings
    parser.add_argument('--result_path', default="../data/kabledata", type=str)
    ...
    parser.add_argument('--batch_size_each', default=400, type=int)
    ...
    parser.add_argument('--w_pen', default=120.0, type=float)
    ...
    with multiprocessing.Pool(len(gpu_list)) as p:
        it = p.imap(generate, process_args)
        list(it)
